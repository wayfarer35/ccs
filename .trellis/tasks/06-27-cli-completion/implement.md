...
- [ ] 5. 新建 `scripts/postinstall.mjs`（自动安装补全到 rc）
...
- [ ] 6. `package.json` 增 `"postinstall": "node scripts/postinstall.mjs"`。

- [ ] 7. 新建 `tests/postinstall.test.ts`
